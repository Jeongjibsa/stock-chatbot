...
describe("buildMockTelegramReportPreview", () => {
  it("builds a reusable mocked telegram report example", () => {
    ...
    expect(preview.renderedText).toContain("삼성전자: 184,000 → 182,000  🔵▼ 1.08%");
    expect(preview.renderedText).toContain("SK하이닉스: 949,000 → 934,000  🔵▼ 1.58%");
    expect(preview.renderedText).toContain("HMM: 21,100 → 20,800  🔵▼ 1.42%");
